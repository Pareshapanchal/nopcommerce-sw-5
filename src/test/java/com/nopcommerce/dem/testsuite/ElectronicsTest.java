...
import com.nopcommerce.dem.pages.ElectronicsPage;
...
public class ElectronicsTest extends BaseTest {
    ...
    // 2.14 Verify the Total $698.00
            ...
            String actualTotal = electronicsPage.getTotal698Text1();
    ...
    // 2.20 Fill the mandatory fields
            electronicsPage.fillFirstNameLastNameField("Shivam","Joshi");
            String email ="Ram"+generateRandomNumber()+"@gmail.com";
            electronicsPage.fillEmailField(email);
    ...
    // 2.24 Verify the text “Shopping card”
                ...
                String actualShoppingCart = electronicsPage.getShoppinCartTextAfterRegister();
                Assert.assertEquals(actualShoppingCart,expectedShoppingCart,"Not Match");
                electronicsPage.clickOnLoginLink();
                electronicsPage.fillEmailFieldInLoginPage(email);
                electronicsPage.fillPasswordInLoginpage("sita123");
                electronicsPage.clickOnLoginbutton();
    // 2.25 click on checkbox “I agree with the terms of service”
                electronicsPage.clickOntermsAndConditionCheckbox1();
    // 2.26 Click on “CHECKOUT”
                electronicsPage.clickOnCheckOutButton1();
    ...
    // 2.33 Fill all the details
                electronicsPage.fillCardHolderNameField("Mrs d Joshi");
